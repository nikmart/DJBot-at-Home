...
Purpose: This is the server for the DJ Bot WoZ Way wizard station. The server acts 
as the webserver for the control interface (which is an HTML page). The server also
manages MQTT messaging to and from DJ Bot. This is needed because there is not
